        ...
        <footer className="queen-footer">
            <div className="footer-top">
                ...
                <span>
                    ...
                    <Link to="/queen" onClick={() => window.scrollTo(0, 0)}>
                        <img src={`${import.meta.env.BASE_URL}assets/header-condensed-logo.png`} alt="Queen" className='queen-logo' />
                    </Link>
                </span>
            </div>
            <p>&copy; 2026</p>
